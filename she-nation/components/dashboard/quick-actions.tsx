...
export function QuickActions() {
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="glass-effect rounded-xl p-6 max-w-xl w-full">
        <h3 className="text-xl font-semibold font-poppins text-gray-900 mb-6 text-center">Quick Actions</h3>
